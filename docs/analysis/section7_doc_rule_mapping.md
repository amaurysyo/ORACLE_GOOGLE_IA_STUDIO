...
- Las reglas R28/R29 están implementadas y gobernadas por `detectors.oi_spike.enabled` (default false) para no alterar producción hasta habilitación explícita; R30/R31 `top_traders` siguen el mismo patrón de feature flag (`detectors.top_traders.enabled=false`). R34–R37 permanecen reservadas como stubs sin lógica en el engine.
