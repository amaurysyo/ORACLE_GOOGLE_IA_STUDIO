...
- **Preparación Opción A**: se reservó el slot R36 para cubrir la brecha restante sin renumerar reglas existentes; el stub documenta nombre, `event_type` y `side` esperados y no altera el runtime hasta conectar el detector específico.【F:oraculo/rules/engine.py†L16-L33】
